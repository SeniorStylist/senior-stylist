...
- **Phase 12E** (PLANNED — Opus) — Tips & Receipts: `tip_cents` on bookings, `default_tip_type/value` on residents, Twilio SMS infrastructure (feature-flagged), Resend email receipts, QB tip line item, payroll tip tracking separate from commission
