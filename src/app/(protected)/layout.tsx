...
import { ViewportDebug } from '@/components/layout/__viewport-debug'
...
export default async function ProtectedLayout({
  ...
  return (
    ...
    <div className="fixed inset-0 flex overflow-hidden" data-debug-shell style={{ backgroundColor: 'var(--color-bg)' }}>
      <ProtectedBodyLock />
      <ViewportDebug />
      <TourModeBanner />
      <NavigationProgress />
