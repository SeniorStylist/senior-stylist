...
export const TUTORIAL_CATALOG: Tutorial[] = [
  ...
  { id: 'bookkeeper-financial-reports', category: 'Reports', title: 'Financial Reports', blurb: 'Run and export reports for accounting.', estMinutes: 3, icon: 'FileSpreadsheet', roles: ['bookkeeper'], tourId: 'bookkeeper-financial-reports', platform: 'desktop' },
