    ...
    steps: [
      {
        ...
        description: 'Your appointments appear on this grid in time order. Click any open slot to add a booking.',
      },
      {
        type: 'highlight',
        selector: '[data-tour="checkin-banner"]',
        title: 'Check in when you arrive',
        description: "Click “I'm Here” when you get to the facility. Running late? Your remaining appointments shift automatically.",
        placement: 'bottom',
      },
      {
        type: 'click',
        ...
        description: 'After each visit you confirm it here. Click Daily Log.',
        placement: 'right',
      },
      {
        type: 'highlight',
      ...
      },
      {
        ...
        description: 'Your schedule, compliance documents, and time off live here. Click My Account.',
        placement: 'right',
      },
      {
        type: 'highlight',
