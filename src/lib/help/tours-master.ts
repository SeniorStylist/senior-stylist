...
export const MASTER_TOURS: ScriptedTour[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Opens the guided new-facility setup.',
        placement: 'bottom',
      },
      {
        type: 'type',
        selector: '[data-tour="wizard-basics-name"]',
        route: '/facilities/new',
        typeValue: 'Sunrise of Denver',
        title: 'Name entered',
        description: "We typed the name. Use the community's full name — it's what families see.",
        placement: 'right',
      },
      {
        type: 'highlight',
        selector: '[data-tour="wizard-basics-code"]',
        title: 'Facility code',
        description: 'Suggested automatically — the next free F-number. It goes on the family sign-up poster.',
        placement: 'right',
      },
      {
        type: 'click',
        selector: '[data-tour="wizard-footer-next"]',
        title: 'Continue to hours',
        description: 'Tap Continue. Next come salon hours, stylists, the price list, and billing — then a printable QR poster.',
        placement: 'top',
      },
    ],
    learnings: [
      'Found the Facilities list',
      'Opened the guided facility setup',
      'Saw how the facility code is suggested',
    ],
  },
